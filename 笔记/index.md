...
## 📝 [运维行为监控与审计](笔记/网络安全/运维行为监控与审计)

**分类**: 信息安全 | **创建时间**: 2025/07/31 | **字数**: 1080 | **阅读时间**: 5分钟

通过将堡垒机日志接入SIEM/SOC系统，实现运维行为实时监控与审计。包括日志采集标准化、SIEM集成、异常检测及自动化响应，提升安全管控。

**标签**: #Python #机器学习 #代码 #总结 #运维监控

---

## 📝 [金融行业红队测试](笔记/网络安全/金融行业红队测试)

**分类**: 金融网络安全 | **创建时间**: 2025/07/23 | **字数**: 3639 | **阅读时间**: 15分钟

TIBER-EU和CBEST是金融业红队测试标杆框架，分别强调跨机构安全提升和监管合规。TIBER-EU适用于欧盟，CBEST针对英国机构，均依赖威胁情报和第三方参与。
...
**分类**: 网络安全 | **创建时间**: 2025/07/23 | **字数**: 744 | **阅读时间**: 3分钟

道德黑客遵循合法、保密、提升安全的原则，使用侦察、扫描、攻击、权限维持等技术工具（如Nmap、Metasploit）进行授权测试，需注意法律风险。

**标签**: #总结 #道德黑客 #渗透测试 #安全工具 #法律风险

---

## 📝 [网络安全防御](笔记/网络安全/网络安全防御)

**分类**: 网络安全 | **创建时间**: 2025/07/23 | **字数**: 1766 | **阅读时间**: 8分钟

《Cyber Defense: Best Practices for Digital Safety》强调网络安全防御重要性，涵盖个人、家庭及企业策略，应对复杂威胁。核心防御包括强密码、MFA、软件更新、数据加密及行为安全。强调持续防护与用户教育。

**标签**: #AI #总结 #网络安全 #数字安全 #防御策略

---

## 📝 [网络安全桌面演练](笔记/网络安全/网络安全桌面演练)

**分类**: 网络安全 | **创建时间**: 2025/07/25 | **字数**: 1076 | **阅读时间**: 5分钟

网络安全桌面演练提升团队协作、明确职责、测试威胁响应，需高管支持、目标设定、场景开发、高效主持和评估。演练减少响应时间，非“打勾练习”。

**标签**: #网络安全 #桌面演练 #事件响应 #合规要求 #团队协作

---

## 📝 [网络安全数据工程](笔记/网络安全/网络安全数据工程)

**分类**: 网络安全与数据工程 | **创建时间**: 2025/07/31 | **字数**: 6713 | **阅读时间**: 27分钟

《网络安全数据工程》教授使用免费开源工具构建安全日志管道，涵盖日志集中化、标准化、自动化与富化，涉及Logstash、Kafka、Elastic架构等，强调TLS加密和Git配置管理。

**标签**: #JavaScript #AI #机器学习 #代码 #图文

---

## 📝 [网络安全指标规划与应用](笔记/网络安全/网络安全指标规划与应用)

**分类**: 网络安全 | **创建时间**: 2025/08/01 | **字数**: 3880 | **阅读时间**: 16分钟

本书通过数据驱动的网络安全指标降低风险，强调指标可量化、可操作、与业务对齐，涵盖METRICS方法论、ATLAS框架及AI/ML应用，实现安全与业务价值融合。

**标签**: #Python #AI #机器学习 #总结 #数据驱动

---

## 📝 [智能持续安全（ICS）](笔记/网络安全/智能持续安全（ICS）)

**分类**: 信息安全 | **创建时间**: 2025/07/25 | **字数**: 3376 | **阅读时间**: 14分钟

ICS通过AI集成DevSecOps和SecOps，实现全生命周期持续安全防护，提升威胁检测、自动化测试和合规监控能力。

**标签**: #AI #机器学习 #总结 #智能安全 #AI驱动

---

## 📝 [汽车网络安全](笔记/网络安全/汽车网络安全)

**分类**: 汽车网络安全 | **创建时间**: 2025/07/23 | **字数**: 822 | **阅读时间**: 4分钟

自动驾驶汽车CAN总线存在安全漏洞，文章提出基于数据优先级的IDS模型，结合DL和ML算法提升检测精度和效率，保障车辆安全。

**标签**: #机器学习 #深度学习 #总结 #自动驾驶 #网络安全

---

## 📝 [后量子时代AI安全](笔记/网络安全/后量子时代AI安全)

**分类**: AI与网络安全 | **创建时间**: 2025/07/25 | **字数**: 1032 | **阅读时间**: 5分钟

后量子时代，AI与量子计算结合构成双重威胁。需采用后量子密码学（PQC）和去中心化架构防御，结合AI技术应对AGI风险，确保未来数字安全。

**标签**: #AI #总结 #后量子安全 #AGI防御 #PQC
